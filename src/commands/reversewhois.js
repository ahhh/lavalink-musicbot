...
const getDeets = async (query) => {
    const body = await (await fetch(`http://api.whoxy.com/?key=e9ddbbd683d80d4xp03bcd61620bf20e&reverse=whois&name=${encodeURIComponent(query)}`)).json();
